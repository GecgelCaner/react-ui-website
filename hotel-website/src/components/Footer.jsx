...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2">
      <div className="mex-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4 ">
        <div>
        ...
        <div className="col-span-2 py-8 md:pt-2">
          ...
          <form className="flex flex-col  sm-flex-row">
            <input
              className="w-full p-2 mr-4 rounded-md mb-4 text-gray-400"
              type="email"
